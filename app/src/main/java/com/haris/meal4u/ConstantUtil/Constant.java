...
public class Constant {
    ...
    public static enum CONNECTION {
        ...
        ADD_FAVOURITES, DELETE_FAVOURITES, ALL_FAVOURITES, PRIVACY_POLICY, DOWNLOAD, HOME, CONFIGURATION, ORDER_HISTORY, DELETE_PAYMENT_CARD, ORDER_RIDER_STATUS, ADD_RIDER_RATING, DELIVERY_CHARGES, UPDATE
    }
