package com.rch.etawah.JsonUtil.HomeUtil;
...
public class HomeJson implements Parcelable
{
    ...
    protected HomeJson(Parcel in) {
        ...
        in.readList(this.featured, (com.rch.etawah.JsonUtil.HomeUtil.Featured.class.getClassLoader()));
        in.readList(this.trending, (com.rch.etawah.JsonUtil.HomeUtil.Trending.class.getClassLoader()));
        in.readList(this.nearest, (com.rch.etawah.JsonUtil.HomeUtil.Nearest.class.getClassLoader()));
    }
