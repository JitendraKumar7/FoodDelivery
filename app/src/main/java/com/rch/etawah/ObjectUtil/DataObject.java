...
import com.rch.etawah.JsonUtil.AppOfferUtil.Category;
import com.rch.etawah.JsonUtil.AppOfferUtil.Offer;
import com.rch.etawah.JsonUtil.CardUtil.Card;
import com.rch.etawah.JsonUtil.CardUtil.CardJson;
import com.rch.etawah.JsonUtil.CategoryUtil.CategoryJson;
import com.rch.etawah.JsonUtil.CouponUtil.CouponJson;
import com.rch.etawah.JsonUtil.DeliveryDetailUtil.DeliveryDetailJson;
import com.rch.etawah.JsonUtil.HomeUtil.Featured;
import com.rch.etawah.JsonUtil.HomeUtil.HomeJson;
import com.rch.etawah.JsonUtil.HomeUtil.Nearest;
import com.rch.etawah.JsonUtil.HomeUtil.RestaurantStatus;
import com.rch.etawah.JsonUtil.HomeUtil.Trending;
import com.rch.etawah.JsonUtil.OrderHistoryUtil.OrderHistoryJson;
import com.rch.etawah.JsonUtil.OrderHistoryUtil.OrderList;
import com.rch.etawah.JsonUtil.OrderHistoryUtil.ProductOrderDetail;
import com.rch.etawah.JsonUtil.OrderUtil.OrderJson;
import com.rch.etawah.JsonUtil.ProductUtil.Product;
import com.rch.etawah.JsonUtil.ProductUtil.ProductAttribute;
import com.rch.etawah.JsonUtil.ProductUtil.ProductJson;
import com.rch.etawah.JsonUtil.ReviewUtil.Review;
import com.rch.etawah.JsonUtil.ReviewUtil.ReviewJson;
import com.rch.etawah.JsonUtil.UserUtil.FavouriteList;
import com.rch.etawah.JsonUtil.UserUtil.UserJson;
    ...
    public static DataObject getDataObject(RequestObject requestObject, Object data) {
        ...
        if (requestObject.getConnection() == Constant.CONNECTION.HOME) {
            ...
            for (int i = 0; i < categoryJson.getCategories().size(); i++) {
                ...
                com.rch.etawah.JsonUtil.CategoryUtil.Category category =
